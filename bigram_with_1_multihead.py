...
class MultiHeadAttention(nn.Module):
    ...
    '''
    def __init__(self, num_heads, head_size, n_embd, block_size) -> None:
        super().__init__()
...
class BigramLanguageModel1MultiHead(pl.LightningModule):
    def __init__(self, vocab_size, cfg) -> None:
        super().__init__()
        self.token_embeding_table = nn.Embedding(vocab_size, cfg.n_embd)
        self.position_embedding_table = nn.Embedding(cfg.block_size, cfg.n_embd)

        self.atten_block = AttentionBlock(cfg.n_embd, cfg.n_head, cfg.block_size)
